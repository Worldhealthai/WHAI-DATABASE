                    ...
                    return (
                      ...
                      >
                          ...
                          <div>
                            ...
                            {(s.contactFirstName || s.contactLastName) && (
                              <div className="text-xs text-slate-500 mt-0.5">
                                {[s.contactFirstName, s.contactLastName].filter(Boolean).join(' ')}
                        ...
                        <div className="flex items-center justify-center gap-2 flex-wrap mt-auto">
                          {s.event && <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-amber-500/10 text-amber-400/70 border border-amber-500/15">{s.event}</span>}
